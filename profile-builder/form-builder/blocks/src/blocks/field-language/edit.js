...
export default function Edit( props ) {
    ...
    const extraPanels = (
        <PanelBody title={ __( 'Language Settings', 'profile-builder' ) }>
            <TextControl
    ...
    return (
        <BaseFieldEdit { ...props } inspectorPanels={ extraPanels }>
            <div style={ { padding: '10px', border: '1px dashed #ccc', backgroundColor: '#fafafa', color: '#666', fontSize: '12px' } }>
                <span className="dashicons dashicons-translation" style={ { marginRight: '5px' } } />
                { __( 'Hidden Language Field', 'profile-builder' ) }
